...
pod 'WordPress-iOS-Shared', :path => '../WordPress-iOS-Shared'
pod 'WordPress-iOS-Editor', :git => 'https://github.com/wordpress-mobile/WordPress-iOS-Editor', :branch => 'release/0.2.1'
